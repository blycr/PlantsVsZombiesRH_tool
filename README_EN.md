...
* **Source**: [pvz_fusion_cheats_v7.py](./pvz_fusion_cheats_v7.py) in the project.
* **Steps**:
  ...
  3. Enter a level, then run from the project root: `.venv\Scripts\python pvz_fusion_cheats_v7.py`
...
| :---: | :--- | :--- |
| 1 | Instant Cooldown x100 | Seed packets, shovel, glove, and hammer cool down instantly. Infinite planting. |
...
| 6 | Specific Plant Speedup | Chomper chewing and Potato Mine arming time cut to 1/20. Animations stay intact. |
...
* **Version Locked**: All memory offsets and signatures are tailored for "Plants vs. Zombies Fusion Edition 3.6.1". Other versions may not work.
