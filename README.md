...
* **适合**：开发者，想改逻辑或看完整实现。
* **源文件**：项目里的 [pvz_fusion_cheats_v7.py](./pvz_fusion_cheats_v7.py)。
* **步骤**：
  ...
  3. 进关卡后，在项目目录执行：`.venv\Scripts\python pvz_fusion_cheats_v7.py`
...
| 快捷键 | 功能 | 效果 |
| :---: | :--- | :--- |
| 1 | 极速冷却 ×100 | 卡牌、手套、锤子 CD 瞬间冷却，可无限连种。 |
...
* **版本绑定**：所有内存特征码和偏移量只适配《植物大战僵尸融合版 3.6.1》，其他版本不保证可用。
